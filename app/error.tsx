  ...
  return (
    <main className="mx-auto max-w-prose py-20 text-center">
      ...
      <button
        type="button"
        onClick={reset}
        className="font-mono text-xs uppercase tracking-[0.08em] px-4 py-2.5 rounded-[5px] border border-fd-border text-fd-foreground hover:border-fd-accent-foreground hover:text-fd-accent-foreground transition-colors"
      >
        Try again
      </button>
    </main>
