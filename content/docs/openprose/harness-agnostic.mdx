...
this contract." Swapping the host -- `codex-sdk`, `claude-sdk`, or a local
`mock` -- changes who provides the five primitives, not what the contract
asks for.
...
whether or not a host chooses to memoize it.
